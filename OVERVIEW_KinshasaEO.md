...
For a brief description of the remote sensing data sources and the science behind them, see this document: [`Remote Sensing Data Descriptions`]([https://github.com/parker-group/Kinshasa_EO/EO_Products.md](https://github.com/parker-group/Kinshasa_EO/blob/main/EO_Products.md))
